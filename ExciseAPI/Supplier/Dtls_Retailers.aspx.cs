...
{
    public partial class Dtls_Retailers : System.Web.UI.Page
    {
        ...
        public void BindDistrict()
        {
            try
            {
                ...
                objSupBE.Statecode = "36";
                DataTable dt1 = new DataTable();
                objSupBE.Action = "R";
                dt1 = ObjMDL.GetDistDL(objSupBE, Session["ConnKey"].ToString());
        ...
        public void BindPrimaryDepotCode()
        {
            try
            {
                ...
                //dt1 = objRDL.RetailerTypeIUDR(objRBE, ConnKey);
                objBE.Action = "DR";// "RM";
                dt1 = ObjMDL.Depots(objBE, ConnKey);
        ...
        public void BindMandal()
        {
            try
            {
                ...
                objSupBE.Action = "R";
                dt1 = ObjMDL.GetmandalsDAL(objSupBE, Session["ConnKey"].ToString());
        ...
        public void BindVillage()
        {
            try
            {
                ...
                objSupBE.Statecode = "36";
                objSupBE.DistCode = ddlDist.SelectedValue;
                objSupBE.MandCode = ddlMandal.SelectedValue;
                objSupBE.Action = "R";
                dt1 = ObjMDL.GetvillDAL(objSupBE, Session["ConnKey"].ToString());
        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    objBE = new Master_BE();
                    objBE.Retailer_Code = Convert.ToInt32(txt_RetailCd.Text);
                    ...
                    //rblPrimary.SelectedIndex = -1;
                    //ddlSecondary.ClearSelection();
                    //rblSecondary.SelectedIndex = -1;

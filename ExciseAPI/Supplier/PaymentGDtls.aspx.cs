...
{
    public partial class PaymentGDtls : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //                objRegBE.FirmId = Session["Firmid"].ToString();
            ...
            //                objRegBE.Action = "UA";
            //                //   dt = objRegDL.GetPaymentUpdateDtls(objRegBE);
            //                dt = objRegDL.GetPaymentSaveDtls(objRegBE);

            //                string StrContent = Session["ApplicantId"].ToString() + "|" + Session["Firmid"].ToString() + "|" + Session["System"].ToString() + "|" + Session["LicenseType"].ToString() + "|" + Session["Licensem"].ToString() + "|" + DateTime.Parse(lbltrydate.Text, provider, System.Globalization.DateTimeStyles.NoCurrentDateDefault).Date + "|" + lblbankStatus.Text.Trim() + "|" + lblchno.Text.Trim() + "|" + lbldepttransid.Text.Trim() + "|" + lblbanktransid.Text.Trim() + "|" + DateTime.Parse(lblbankdate.Text, provider, System.Globalization.DateTimeStyles.NoCurrentDateDefault).Date + "\n";
        ...
        {
            Response.Redirect("~/Supplier/PaymentView.aspx");

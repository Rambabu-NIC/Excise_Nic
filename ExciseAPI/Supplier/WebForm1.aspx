<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="ExciseAPI.Supplier.WebForm1" %>

<%--<%@ Register TagPrefix="Menu" TagName="menu" Src="~/Supplier/WebUserControl1.ascx" %>--%>
    ...
    <div class="w-100 fl container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                            <h5 class="card-title"><center>Molasses_M5</center></h5><br/>
                        <form>

...
{
    public partial class SupplierPaymentDtls : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                lblmfcd.Text = Session["Type_of_Manufacturing"].ToString();
                BindDuty();
                // BindTypeofpayment();
                random();
        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            if (txtAmt.Text != "0" && txtAmt.Text != "")
            {
                ...
                objBE.Type_of_Duties = ddlTypeofpayment.SelectedValue;
                objBE.Action = "IA";
                ...
                sb.AppendFormat("<input type='hidden' name='remittersname' value='{0}'>", Session["UsrName"].ToString() +'/' + Session["SuppName"].ToString());
                sb.AppendFormat("<input type='hidden' name='amount' value='{0}'>", txtAmt.Text);//
                //sb.AppendFormat("<input type='hidden' name='dru' value='{0}'>", "http://localhost/Excise/Supplier/SupplierPaymentView");
                sb.AppendFormat("<input type='hidden' name='dru' value='{0}'>", WebApiConfig.paymentredirect + "/Supplier/SupplierPaymentView");
        ...
        public void BindHOA()
        {
            try
            {
                ...
                objBE.Action = "HA";
                dt1 = objDL.CommonMasters(objBE, Session["ConnKey"].ToString());
                txtHOA.Text = dt1.Rows[0]["HOA_Code"].ToString();
                //objCommon.BindDropDownLists(ddlSubH, dt1, "Sub_Head_Desc", "Sub_Head_Code", "0");
            }
            catch (Exception ex)
            {
        ...
        protected void ddlduty_SelectedIndexChanged1(object sender, EventArgs e)
        {

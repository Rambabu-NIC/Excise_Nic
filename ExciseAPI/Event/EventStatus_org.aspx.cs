...
{
    public partial class EventStatus_org : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!validatemobile(txtMobileNumber.Text))
            {
        ...
        protected void txtDate_TextChanged(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(txtDate.Text) && Convert.ToDateTime(txtDate.Text.ToString()) < DateTime.Now)
            {
                txtDate.Text = "";

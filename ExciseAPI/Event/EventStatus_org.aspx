<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Event/Event.master" CodeBehind="EventStatus_org.aspx.cs" Inherits="ExciseAPI.Event.EventStatus_org" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="w-100 fl container-fluid">
        <div class="block black bg-white">
            ...
            <div class="content">
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 p-0 xs-field">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-8">
                        <asp:TextBox ID="txtDate" CssClass="form-control input-b-b" runat="server" placeholder="From Date" AutoCompleteType="Disabled"></asp:TextBox>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 p-0 xs-field">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-8">
                        <asp:TextBox ID="txtMobileNumber" CssClass="form-control input-b-b" runat="server" MaxLength="10" OnTextChanged="txtMobileNumber_TextChanged" AutoPostBack="true"></asp:TextBox>
                         <%--<asp:RequiredFieldValidator ID="rfvNeededBy" runat="server" ControlToValidate="txtMobileNumber" Text="*" Display="Dynamic"  />
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 p-0 xs-field">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-8">
                        <asp:TextBox ID="txtEmail" CssClass="form-control input-b-b" runat="server" OnTextChanged="txtEmail_TextChanged"  AutoPostBack="true"></asp:TextBox>
            ...
            <div class="content" align="center">
                <div class="col-xs-12 col-sm-12 txt-cnt">
                    <asp:Button ID="btnSave" CssClass="btn btnn btn-sm text-uppercase m-t-10" runat="server" OnClick="btnSave_Click"

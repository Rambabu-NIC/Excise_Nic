...
namespace ExciseAPI.Event
{
    public partial class ApplicationStatus : System.Web.UI.Page
    {
        ...
        protected bool Validate()
        {
            ...
            {
                objCommon.ShowAlertMessage("Enter Registration Number");
                ...
                if (Validate())
                {
                    if (CheckCaptcha())
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            //lblApplicationStatus.Text = dt.Rows[0]["ApplicationStatus"].ToString();
                            if (dt.Rows[0]["Status"].ToString() == "1")
                                lblApplicationStatus.Text = dt.Rows[0]["ApplicationStatus"].ToString() + ", If any Queries Please contact SHO on Mobile No :" + dt.Rows[0]["SMobile"].ToString();
                            else
                                lblApplicationStatus.Text = dt.Rows[0]["ApplicationStatus"].ToString();

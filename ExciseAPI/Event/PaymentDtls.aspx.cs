    ...
    public partial class PaymentDtls : System.Web.UI.Page
    {
        ...
        protected void Getdata()
        {
            try
            {
                ...
                if (dt1.Rows.Count > 0)
                {
                    if (dt1.Rows[0]["BankStatus"].ToString() == "Success")
                    {
                        divPayment.Visible = false;
                        t1.Visible = true;
                        lblReGNoP.Text = Session["RegId"].ToString();
                        lblAmt.Text = dt1.Rows[0]["License_Fee"].ToString();
                    ...
                    else
                    {
                        ...
                        string value = objCommon.ShaEncrypt(dt1.Rows[0]["License_Fee"].ToString() + myval.ToLower());
                        Session["EventLicenseFeeHash"] = value; 
        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            if (lblFee.Text != "0" && lblFee.Text != "")
            {
                ...
                if (value.ToString() != Session["EventLicenseFeeHash"].ToString())
                {
            ...
            try
            {
                ...
                // if (Validate())
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        Response.Redirect("~/Event/EventSelection.aspx", false);
                        // Viewdata();

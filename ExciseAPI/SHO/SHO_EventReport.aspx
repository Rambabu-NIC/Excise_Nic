<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SHO_EventReport.aspx.cs" Inherits="ExciseAPI.SHO.SHO_EventReport" %>
                            ...
                            <div id="divgridwithdate1" runat="server" visible="true">
                                ...
                                <div class="w-100 fl container-fluid" id="divgriddetails" runat="server" visible="true">
                                 ...
                                 <br />
                                         ...
                                         <div id="div" style="max-height:600px;overflow-y:scroll;" >
                                        ...
                                        <asp:GridView ID="GvRptDtls" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered nowrap gvv"
                                            AllowPaging="True" PageSize="20" OnPageIndexChanging="GvRptDtls_PageIndexChanging" OnRowDataBound="GvRptDtls_RowDataBound"

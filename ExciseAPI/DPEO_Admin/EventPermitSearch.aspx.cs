...
namespace ExciseAPI.DPEO_Admin
{
    public partial class EventPermitSearch : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["Role"] != null && Session["Role"].ToString() == "10" && Session["AuthToken"] != null && Request.Cookies["AuthToken"] != null)
            {
        ...
        {
            if (string.IsNullOrEmpty(txtRegistrationNO.Text.ToString()) && string.IsNullOrEmpty(txtMobileNo.Text.ToString()))
            {
                objCommon.ShowAlertMessage("Please Enter Registration No or Mobile Number");

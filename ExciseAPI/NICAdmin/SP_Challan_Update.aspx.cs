...
{
    public partial class SP_Challan_Update : System.Web.UI.Page
    {
        ...
        protected void Viewdata()
        {
            try
            {
                ...
                objBE.from = txtFrom.Text.ToString().Trim();
                objBE.To = txtTo.Text.ToString().Trim();
                Retailerdt = objDL.Get_transactions_transdatepending(objBE, ConnKey);

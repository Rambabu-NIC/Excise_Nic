...
{
    public partial class Dashboard_ERCS_I : System.Web.UI.Page
    {
        ...
        protected void GvRptDtls_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            try
            {
                ...
                if (validateDates())
                {
                    objBE.Action = "EDB_GET_TM_I";
                    objBE.BdrEast = "TMPC_DT_I";
        ...
        protected void GvRptDtls_SelectedIndexChanged(object sender, EventArgs e)
        {

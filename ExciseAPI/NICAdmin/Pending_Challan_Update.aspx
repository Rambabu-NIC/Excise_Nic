<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Pending_Challan_Update.aspx.cs" Inherits="ExciseAPI.NICAdmin.Pending_Challan_Update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="w-100 fl container-fluid">
        <div class="block black bg-white">
            <div class="head">Retailer Payment update</div>
            <div class="content">
            ...
            <div class="content text-center">
                <div class="col-xs-10 col-sm-10 txt-cnt">

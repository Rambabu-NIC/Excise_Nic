<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="VerifiedTransactions.aspx.cs" Inherits="ExciseAPI.NICAdmin.VerifiedTransactions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="w-100 fl container-fluid">
        ...
        <div class="block black bg-white">
            <div class="head">Retailer's Verified Challan Report</div>
            <div class="content">
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 p-0 xs-field">
                    <label class="col-xs-4 col-sm-5 col-md-5 col-lg-4">Date(yyyy-mm-dd)</label>
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:TextBox ID="txtDate" CssClass="form-control input-b-b" runat="server" placeholder="Date" AutoCompleteType="Disabled"></asp:TextBox>

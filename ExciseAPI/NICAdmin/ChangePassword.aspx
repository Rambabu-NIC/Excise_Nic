<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="ExciseAPI.NICAdmin.ChangePassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="w-100 fl container-fluid">
        <div class="block black bg-white">
            ...
            <asp:Button ID="btn_Submit" runat="server" Text="Submit" CssClass="btn btn-secondary btnn btn-sm text-uppercase m-t-10" OnClick="btn_Submit_Click" OnClientClick="validateReg();" />
  </div>
                 </div>
                        </div>

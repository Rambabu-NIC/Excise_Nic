<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EventPermitSearch.aspx.cs" Inherits="ExciseAPI.NICAdmin.EventPermitSearch" %>
            ...
            <div class="content">
                ...
                <div class="content text-center">
                    <div class="col-xs-12 col-sm-12 txt-cnt">
                        <asp:Button ID="btnGet" runat="server" Text="Get Data" Visible="true" CssClass="btn btn-secondary btnn btn-sm text-uppercase m-t-10" OnClick="btn_Get_Click" />
            ...
            <div class="content">
                <asp:Panel ID="pnldynamic" runat="server" BorderColor="#b2beb5" BorderStyle="Solid">
                    ...
                    <div class="block black bg-white">
                        ...
                        <div class="form-group row col-md-12">
                            <label class="col-md-3 col-form-label text-right">
                                Whether the Permises is
                                <br />
                                in Conformity with the<br />
                                Rule 7 of Telangana<br />
                                Excise(Grant
                                                                    of Licence of
                                <br />
                                Selling by In-House&amp;<br />
                                Conditions of
                                <br />

<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Mst_ManufMinorH.aspx.cs" Inherits="ExciseAPI.Admin.Mst_ManufMinorH" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="w-100 fl container-fluid">
        ...
        <div class="block black bg-white">
            <div class="head">Minor Head Description</div>
            <div class="content">
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6 p-0 xs-field">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:TextBox ID="txt_MinorCd" CssClass="form-control input-b-b" runat="server"></asp:TextBox>
                    </div>
                </div>
                 <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6 p-0 xs-field">
                    <label class="col-xs-4 col-sm-5 col-md-5 col-lg-4">Major Head Description</label>
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:Label ID="lblidok" runat="server" Visible="false"></asp:Label>
                        <asp:TextBox ID="txt_MinorNm" CssClass="form-control input-b-b" runat="server"></asp:TextBox>
                    </div>
                </div>
            ...
            <div class="w-100 fl container-fluid" id="DivDF" runat="server" visible="false">
                ...
                <div class="block black bg-white">
                    <asp:GridView ID="GvDF" runat="server" AllowPaging="True" PageSize="5" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Major Head Code">
                                <ItemTemplate>
                                    <asp:Label ID="lblMHCd" runat="server" Text='<%# Bind("Minor_Head_Code") %>'></asp:Label>

                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Major Head  Description">
                                <ItemTemplate>

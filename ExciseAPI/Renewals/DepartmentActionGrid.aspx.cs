...
{
    public partial class DepartmentActionGrid : System.Web.UI.Page
    {
        ...
        public void BindDetails()
        {
            ...
            GetDeptDetails = objDL.GetDepartmentRenewalAPPDetails(Role,UserName,EXDIST_CODE, ApplicationType, UserSection, ConnKey);
        ...
        protected void gvdetails_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "lkbApplicationView")
            {
                ...
                {
                    Response.Redirect("~/Renewals/ViewMBRenewal.aspx", false);
                }
            }
        }
    }

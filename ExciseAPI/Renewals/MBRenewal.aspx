<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MBRenewal.aspx.cs" Inherits="ExciseAPI.Supplier.MBRenewal" %>
                ...
                <div class="content">
                    <asp:GridView ID="gvdetails" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered nowrap gvv">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Supplier_Code" HeaderText="Supplier_Code" />
                ...
                <div class="content">
                    <asp:GridView ID="gvPaymentDetails" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered nowrap gvv">
                        <Columns>
                            ...
                            <asp:BoundField DataField="DF_Descr" HeaderText="Payment Type" />
            ...
            <div class="block black bg-white">
                ...
                <div class="content" align="center">
                    <div class="col-xs-12 col-sm-12 txt-cnt">
                        <asp:Button ID="btnNext" CssClass="btn btnn btn-sm text-uppercase m-t-10" runat="server"
                ...
                <div class="w-100 fl container-fluid">
                    <div class="block black bg-white">
                        ...
                        <div class="content">
                            ...
                            <div class="col-xs-12 col-sm-12 txt-cnt">
                                <asp:Button ID="btnAddUpload" runat="server" Text="ADD ROW" CssClass="btn btnn btn-sm text-uppercase" OnClick="btnAddUpload_Click" />
                            </div>
                        </div>
                    </div>
                </div>

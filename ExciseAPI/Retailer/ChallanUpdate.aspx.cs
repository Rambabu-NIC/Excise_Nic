...
{
    public partial class ChallanUpdate : System.Web.UI.Page
    {
        ...
        protected void Viewdata()
        {
            try
            {
                ...
                objBE.To = txtTo.Text;
                //objBE.Action = ddlPaymenttype.SelectedValue;
                Retailerdt = objDL.Get_Retailer(objBE, ConnKey);
        ...
        protected void btn_Get_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(txtFrom.Text) && !string.IsNullOrEmpty(txtTo.Text) && Convert.ToInt32(ddlPaymenttype.SelectedValue) >0)
            {
                Viewdata();
            }
            else
                ...
                if (gvRetailerdetails.Rows.Count > 0)
                {
                    ...
                    if (!string.IsNullOrEmpty(Transactionchek))
                    {
                        ...
                        if (ds.Tables.Count > 0)
                        {
                            ...
                            DataTable dataTable  = objDL.Retailer_CyberChallanUpdate(dt, objBE, ConnKey);

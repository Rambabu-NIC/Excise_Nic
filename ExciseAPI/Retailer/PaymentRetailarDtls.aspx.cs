...
{
    public partial class PaymentRetailarDtls : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["IsMultipleDepot"].ToString() == "1")
            {
                Response.Redirect("~/Retailer/DepotSelection.aspx");
            }
        ...
        public void BindData()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(DeptCode) && !string.IsNullOrEmpty(RetailerCode))
                {
                    ...
                    dtRetailer = objDL.GetRetailerDetails(objBE, ConnKey);

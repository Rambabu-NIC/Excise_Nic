<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.master" CodeBehind="Retailer_Upload_Update.aspx.cs" Inherits="ExciseAPI.Retailer.Retailer_Upload_Update" %>
            ...
            <div class="content">
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 p-0 xs-field">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-8">
                        <asp:FileUpload ID="FileUpload_docs" runat="server" class="form-control input-b-b" />

<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="ExciseAPI.Retailer.ChangePassword" %>
    ...
    <script type="text/javascript">
        function validateReg() {
            ...
            if (newpwd != '' && cpwd != '') {
                ...
                document.getElementById('<%= txtconfirmpassword.ClientID %>').value = myval2;
                return true;
            }
            else {
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 p-0 xs-field">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        ...
                        <asp:RegularExpressionValidator ID="revPassword" runat="server" ErrorMessage="Password must be at least 8 characters long and include a combination of uppercase and lowercase letters, numbers, and special characters."
                            ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$" ControlToValidate="txtPassword" ForeColor="Red"></asp:RegularExpressionValidator>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 p-0 xs-field">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Password must be at least 8 characters long and include a combination of uppercase and lowercase letters, numbers, and special characters."
                            ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$" ControlToValidate="txtconfirmpassword" ForeColor="Red"></asp:RegularExpressionValidator>

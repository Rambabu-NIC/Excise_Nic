<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.master"  CodeBehind="RetailerWiseReport.aspx.cs" Inherits="ExciseAPI.Retailer.RetailerWiseReport" %>
        ...
        <div class="block black bg-white">
            ...
            <div class="content">
                ...
                <div class="col-xs-8 col-sm-7 col-md-7 col-lg-8 text-center">
                    <asp:Button ID="Button1" class="btn btn-secondary btnn btn-sm text-uppercase m-t-10" formnovalidate="formnovalidate"
                    ...
                    <div class="w-100 fl container-fluid" id="divgriddetails" runat="server" visible="true">
                        <div class="block-liner block black bg-white">
                            <div id="divheading" class="col-md-12 text-center" runat="server" visible="false">
                                ...
                                <h2 style="text-align: center; font-weight: bold;">Statement showing the details of Retailer Wise Report 
                                 <br /> 
                                 <br />

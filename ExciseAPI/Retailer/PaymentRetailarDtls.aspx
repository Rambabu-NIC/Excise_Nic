<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.master" CodeBehind="PaymentRetailarDtls.aspx.cs" Inherits="ExciseAPI.Retailer.PaymentRetailarDtls" %>
    ...
    <div class="w-100 fl container-fluid">
        <div class="block black bg-white">
            ...
            <div class="content">
                <div class="form-group col-xs-12 col-sm-6 col-md-8 col-lg-9">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:TextBox ID="txtdeptName" runat="server" CssClass="form-control input-b-b" ReadOnly="true" Enabled="false"></asp:TextBox>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-8 col-lg-9">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:TextBox ID="txtRetailerCode" runat="server" CssClass="form-control input-b-b" ReadOnly="true" Enabled="false"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group col-xs-12 col-sm-6 col-md-8 col-lg-9">
                    <label class="col-xs-4 col-sm-5 col-md-5 col-lg-4">Lisence Name</label>
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:TextBox ID="txtlincesename" runat="server" CssClass="form-control input-b-b" ReadOnly="true" Enabled="false"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group col-xs-12 col-sm-6 col-md-8 col-lg-9">
                    <label class="col-xs-4 col-sm-5 col-md-5 col-lg-4">Shop Name</label>
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:TextBox ID="txtshopName" runat="server" CssClass="form-control input-b-b" ReadOnly="true" Enabled="false"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group col-xs-12 col-sm-6 col-md-8 col-lg-9">
                    <label class="col-xs-4 col-sm-5 col-md-5 col-lg-4">Gazette Code</label>
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:TextBox ID="txtGazette_Code" runat="server" CssClass="form-control input-b-b" ReadOnly="true" Enabled="false"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group col-xs-12 col-sm-6 col-md-8 col-lg-9">
                    <label class="col-xs-4 col-sm-5 col-md-5 col-lg-4">Retailer Address</label>
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:TextBox ID="txtretaileraddress" runat="server" CssClass="form-control input-b-b" ReadOnly="true" Enabled="false"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-8 col-lg-9">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:TextBox ID="txtexciselicenseno" runat="server" CssClass="form-control input-b-b" ReadOnly="true" Enabled="false"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-8 col-lg-9">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:TextBox ID="txthead" runat="server" CssClass="form-control input-b-b" ReadOnly="true" Enabled="false"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-8 col-lg-9">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:TextBox ID="txtddocode" runat="server" CssClass="form-control input-b-b" ReadOnly="true" Enabled="false"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-8 col-lg-9">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:TextBox ID="txtpurpose" runat="server" CssClass="form-control input-b-b" ReadOnly="true" Enabled="false"></asp:TextBox>
                    </div>
                </div>
            ...
            <div class="content text-center">
                    <asp:Button ID="btnpaymentSubmit" runat="server" Text="Submit" CssClass="btn btn-secondary btnn btn-sm text-uppercase m-t-10"

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Retailer_TransactionDate.aspx.cs" Inherits="ExciseAPI.Retailer.Retailer_TransactionDate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="w-100 fl container-fluid" id="divBankTransactionDetails" runat="server" visible="false">
        <div class="block-liner block bg-white">
            <div class="content">
                 <div class="w-100 fl m-b-2" align="right">
                    <div class="fr">
                        <a href="#">
                            <asp:ImageButton ID="btnBankTrasactionImageExportToPdf" runat="server" ImageUrl="~/Assets/images/PDF.png"
                                Width="29" ToolTip="Generate Pdf File" Visible="false"
                                OnClick="btnBankTrasactionImageExportToPdf_Click" />
                        </a>&nbsp;&nbsp; <a href="#">

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.master" CodeBehind="SalesProceedingViewPayment.aspx.cs" Inherits="ExciseAPI.Retailer.SalesProceedingViewPayment" %>
        ...
        <ContentTemplate>
            <div class="w-100 fl container-fluid">
                <div class="block black bg-white">
                    <div class="head">Sales Proceeding View Payment</div>
                    <div class="content">
                        <asp:GridView ID="gvdetails" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered nowrap gvv"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="retl_code" HeaderText="Retailer_Code" />
                                <asp:BoundField DataField="retlname" HeaderText="Retailer Name" />
                                <asp:BoundField DataField="unit_code" HeaderText="Depot Code" />
                                <asp:BoundField DataField="ddo" HeaderText="DDO Code" />
                                <%--<asp:BoundField DataField="transaction_id" HeaderText="Dept Transaction" />--%>
                                <asp:BoundField DataField="Expr1" HeaderText="Amount" />
                                <asp:BoundField DataField="bank_status" HeaderText="Bank Status" />
                                <asp:BoundField DataField="challan_num" HeaderText="Challan Number" />

                                <asp:TemplateField HeaderText="View" ItemStyle-CssClass="txt-cnt">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkview" runat="server" Text="Click..!" CommandName="View" CommandArgument='<%# Eval("transaction_id").ToString()%>' ForeColor="Green"></asp:LinkButton>
                                        <%--OnClientClick="javascript:return Print('PrintDiv');"--%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
    ...
    <script type="text/javascript">
        function ReciptConfirm() {
            ...
            $(window).load(function () {
                $('#ModelRecieptPopupConfirm').modal('show');
            });
            return true;
        };

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.master" CodeBehind="RPaymentDtls.aspx.cs" Inherits="ExciseAPI.Retailer.RPaymentDtls" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="w-100 fl container-fluid">
        <div class="block black bg-white">
            <div class="head">Cpe Payment</div>
            <div class="content">
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6 p-0 xs-field">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:RadioButtonList ID="rbdstatus" runat="server" RepeatDirection="Vertical" OnSelectedIndexChanged="RbRemarks_SelectedIndexChanged" 
                            AutoPostBack="true">
                            <asp:ListItem Text="Full Pay" Value="1" Selected="True"></asp:ListItem>
       ...
       ID="cvEndYear2" Operator="GreaterThanEqual" runat="server" Type="Integer"
        ControlToValidate="txtBalancepaid"  
       ControlToCompare="txtAmt" ForeColor="Red" ErrorMessage="Check balance amount" SetFocusOnError="true">
</asp:CompareValidator>
                    </div>
                </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site_M.Master" AutoEventWireup="true" CodeBehind="ChangePassword_M.aspx.cs" Inherits="ExciseAPI.Retailer.ChangePassword_M" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="w-100 fl container-fluid">
        ...
        <div class="block black bg-white">
            <div class="head">Questionnaire</div>
            <div class="content">
                 ...
                 <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 p-0 xs-field">
                    ...
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5">
                        <asp:TextBox ID="txtAnswer" CssClass="form-control input-b-b" runat="server" placeholder="Answer"
                            ></asp:TextBox>

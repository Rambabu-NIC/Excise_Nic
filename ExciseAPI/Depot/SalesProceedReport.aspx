<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.master" CodeBehind="SalesProceedReport.aspx.cs" Inherits="ExciseAPI.Depot.SalesProceedReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="w-100 fl container-fluid">
        <div class="block black bg-white">
            <div class="head">Retailer Sales Proceeds </div>
            <div class="content">
                ...
                <div id="depot" runat="server" visible="false">
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 p-0 xs-field">
        ...
        <div class="w-100 fl container-fluid" id="divretailer" runat="server" visible="false">
            <div class="block black bg-white">
                 <div class="head">Retailer Sales Proceeds Report </div>
                <div class="content">

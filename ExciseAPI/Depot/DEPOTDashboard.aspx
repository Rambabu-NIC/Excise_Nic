<%@ Page Language="C#" MasterPageFile="~/Site1.master" AutoEventWireup="true" CodeBehind="DEPOTDashboard.aspx.cs" Inherits="ExciseAPI.Depot.DEPOTDashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="w-100 fl container-fluid">
        ...
        <div class="block black bg-white">
            <div class="head">Dpeo Dashboard</div>
            <div class="content">

                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 p-0 xs-field">
                    <label class="col-xs-4 col-sm-5 col-md-5 col-lg-4">From Date (yyyy-mm-dd)</label>
                    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-8">
                        <asp:TextBox ID="txtfrm" CssClass="form-control input-b-b" runat="server" placeholder="From Date"></asp:TextBox>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 p-0 xs-field">
                    <div class="col-xs-12 col-sm-12 txt-cnt">
                        <asp:Button ID="btnGet" runat="server" Text="GetDetails" CssClass="btn btnn btn-sm text-uppercase m-t-10" OnClick="btnGet_Click" />
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 txt-cnt">
    ...
    <div class="w-100 fl container-fluid" id="divretailer1" runat="server" visible="false">
    ...
    <div class="w-100 fl container-fluid" id="divretailer2" runat="server" visible="false">
        <div class="block-liner block bg-white">
            <div class="content">

...
namespace ExciseAPI.EODB
{
    public partial class DM1 : System.Web.UI.Page
    {
        ...
        private void ShowCurrentTab()
        {
            ...
            tab7.Visible = CurrentTab == 7;
            tab8.Visible = CurrentTab == 8;
            ...
            btntab7.Enabled = true;
            btntab8.Enabled = true;
            if (CurrentTab == 1)
            {
            ...
            if (CurrentTab == 7)
            {
                btntab7.Enabled = false;
            }
            if (CurrentTab == 8)
            {
                btntab8.Enabled = false;
            }
            btnPrevious.Enabled = CurrentTab > 1;
            btnNext.Enabled = CurrentTab < 8;
        }
        ...
        public void DM1insert()
        {
            ...
            SqlParameter[] Params =
                {
                    ...
                    //
                    new SqlParameter("@ProdCapacity_Proposed_Increase",txtPCapacity.Text.ToString()),
                    //new SqlParameter("@Loi_Validity",txtLOI.Text.ToString()),
                    new SqlParameter("@FirstHalf_Fristyear",txtFFirstHalf.Text.ToString()),
                    new SqlParameter("@SecondHalf__Fristyear",txtFSecondHalf.Text.ToString()),
                    new SqlParameter("@FirstHalf_Secondyear",txtSFirst.Text.ToString()),
                    new SqlParameter("@SecondHalf_Secondyear",txtSSecond.Text.ToString()),
                    new SqlParameter("@FirstHalf_Thirdyear",txtTFirstHalf.Text.ToString()),
                    new SqlParameter("@SecondHalf_Thirdyear",txtTSecondHalf.Text.ToString()),
                    new SqlParameter("@FirstHalf_Fourthyear",txtFFourth.Text.ToString()),
                    new SqlParameter("@SecondHalf_Fourthyear",txtSFourth.Text.ToString()),
                    ...
                    new SqlParameter("@Q_Ena",txtENA_Quantity.Text.ToString()),
                    new SqlParameter("@Q_Ena_Value",txtENA_Value.Text.ToString()),
            ...
            try
            {
                ...
                DataSet data = sql.GetDataInsert(ConfigurationManager.ConnectionStrings["Excise_IMS"].ConnectionString, "DM1_Insert", Params, dtdocument,ParameterTypeName, TypeName);
        ...
        {
            int ApplicantType = 1; int SubApplicantType = 2; int FormType = 1;

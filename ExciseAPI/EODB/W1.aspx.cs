    ...
    public partial class W1 : System.Web.UI.Page
    {
        ...
        public void DM1insert()
        {
            ...
            SqlParameter[] Params =
                {
                    ...
                    new SqlParameter("@Q_Sprit",txtsprit_Quantity.Text.ToString()),
                    new SqlParameter("@Q_Sprit_value",txtsperit_Value.Text.ToString()),
            ...
            try
            {
                ...
                DataSet data = sql.GetDataInsert(ConfigurationManager.ConnectionStrings["Excise_IMS"].ConnectionString, "W1_Insert", Params, dtdocument,ParameterTypeName, TypeName);
        ...
        {
            int ApplicantType = 1; int SubApplicantType = 5; int FormType = 1;
        ...
        protected void btnW1tab1_Click(object sender, EventArgs e)
        {
            CurrentTab = 1;
            if (CurrentTab == 1)
            {
            ...
            btnW1tab1.Enabled = false;
        }

        protected void btnW1tab2_Click(object sender, EventArgs e)
        {
            CurrentTab = 2;
            if (CurrentTab < 3)
            {
            ...
            btnW1tab2.Enabled = false;
        }

        protected void btnW1tab3_Click(object sender, EventArgs e)
        {
            CurrentTab = 3;
            if (CurrentTab < 4)
            {
            ...
            btnW1tab3.Enabled = false;
        }

        protected void btnW1tab4_Click(object sender, EventArgs e)
        {
            CurrentTab = 4;
            if (CurrentTab < 5)
            {
        ...
        {
            W1tab1.Visible = CurrentTab == 1;
            W1tab2.Visible = CurrentTab == 2;
            W1tab3.Visible = CurrentTab == 3;
            W1tab4.Visible = CurrentTab == 4;

            btnW1tab1.Enabled = true;
            btnW1tab2.Enabled = true;
            btnW1tab3.Enabled = true;
            btnW1tab4.Enabled = true;
            if (CurrentTab == 1)
            {
                btnW1tab1.Enabled = false;
            }

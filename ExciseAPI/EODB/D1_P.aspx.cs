...
{
    public partial class D1_P : System.Web.UI.Page
    {
        ...
        public void D1Pinsert()
        {
            ...
            try
            {
                ...
                DataSet data = sql.GetDataInsert(ConfigurationManager.ConnectionStrings["Excise_IMS"].ConnectionString, "D1P_Insert", Params, dtdocument,ParameterTypeName, TypeName);

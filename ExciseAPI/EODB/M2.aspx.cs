    ...
    public partial class M2 : System.Web.UI.Page
    {
        ...
        public void M2Insert()
        {
            ...
            SqlParameter[] Params =
               {
                    ...
                    new SqlParameter("@MolassesQuintals",txtMolassesQuintals.Text.ToString()),
                    new SqlParameter("@MolassesLicense",txtMolassesLicense.Text.ToString()),
                    new SqlParameter("@MolassesQty",txtMolassesQty.Text.ToString()),
                    new SqlParameter("@Molasses",txtMolasses.Text.ToString()),
                    new SqlParameter("@RequiredQty",txtRequiredQty.Text.ToString()),
                    new SqlParameter("@License_Period",txtPeriod.Text.ToString()),
            ...
            try
            {
                ...
                DataSet data = sql.GetDataInsert(ConfigurationManager.ConnectionStrings["Excise_IMS"].ConnectionString, "M2_Insert", Params, dtdocument, ParameterTypeName, TypeName);
        ...
        {
            int ApplicantType = 1; int SubApplicantType = 6; int FormType = 2;
        ...
        protected void btnM2tab1_Click(object sender, EventArgs e)
        {
            CurrentTab = 1;
            if (CurrentTab == 1)
            {
            ...
            btnM2tab1.Enabled = false;
        }

        protected void btnM2tab2_Click(object sender, EventArgs e)
        {
            CurrentTab = 2;
            if (CurrentTab < 3)
            {
        ...
        {
            M2tab1.Visible = CurrentTab == 1;
            M2tab2.Visible = CurrentTab == 2;

            btnM2tab1.Enabled = true;
            btnM2tab2.Enabled = true;
